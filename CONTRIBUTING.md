# Contributing to Dockin-CNI

Welcome to Dockin-CNI! This document is a guideline about how to contribute to Dockin-CNI.
...
You should have Golang installed in your operating system.
...
Please make sure the PR has a corresponding issue. [GitHub Issues](https://github.com/WeBankFinTech/Dockin-CNI/issues)
...
We use [GitHub Issues](https://github.com/WeBankFinTech/Dockin-CNI/issues) and [Pull Requests](https://github.com/WeBankFinTech/Dockin-CNI/pulls) for trackers.

If you find a typo in a document, find a bug in code, or want new features, or want to give suggestions,
you can [open an issue on GitHub](https://github.com/WeBankFinTech/Dockin-CNI/issues/new) to report it.
